...
class AIBase:
    """Base class with common AI functionality"""
    ...
    def __init__(self, 
        ...
        """
        Initialize the AI base with flexible model selection.
        """
    ...
    def _build_messages(self, user_prompt: str, role: Role) -> Dict[str, Any]:
