...
class Model(Enum):
    # OpenAI models
    CHATGPT_O3_MINI = ("gpt-o3-mini", "ChatGPT", Privacy.EXTERNAL, Quality.HIGH, Speed.FAST)
    CHATGPT_4O_MINI = ("gpt-4o-mini", "ChatGPT", Privacy.EXTERNAL, Quality.MEDIUM, Speed.FAST)

    # Anthropic models
    CLAUDE_SONNET_3_7 = ("claude-3-7-sonnet-20250219", "ClaudeAI", Privacy.EXTERNAL, Quality.HIGH, Speed.FAST)
    CLAUDE_SONNET_3_5 = ("claude-3-5-sonnet-latest", "ClaudeAI", Privacy.EXTERNAL, Quality.MEDIUM, Speed.FAST)
    ...
    GEMINI_2_FLASH = ("gemini-2-flash", "Gemini", Privacy.EXTERNAL, Quality.HIGH, Speed.FAST)
    GEMINI_2_FLASH_LITE = ("gemini-2-flash-lite", "Gemini", Privacy.EXTERNAL, Quality.MEDIUM, Speed.FAST)
